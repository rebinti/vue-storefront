export default {
  ...
  meta: [
    { charset: 'utf-8' },
    { vmid: 'description', name: 'description', content: 'iCLOTHING is a standalone PWA storefront for your eCommerce, possible to connect with any eCommerce backend (eg. Magento, Prestashop or Shopware) through the API.' },
