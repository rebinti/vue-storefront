    ...
    <fieldset>
      ...
      <div>
        ...
        <input type="text" name="mobile" id="mobile" required=""
               :class="{ mobile , error: !fields.mobile.valid }"
               v-model="fields.mobile.value">
      </div>
      <div>
        <label class="label" for="textarea">Comment</label>
        <textarea class="message" name="textarea" id="textarea" required="" 
                  v-model="fields.message.text" 
                  :maxlength="fields.message.maxlength"></textarea>
        <span class="counter">{{ fields.message.text.length }} / {{ fields.message.maxlength }}</span>
      </div>
      <div>
